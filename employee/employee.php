...
<head>
    ...
    <link rel="stylesheet" href="../res/css/employee/style-employee.css" type="text/css" />
...
<body>
    ...
    <script type="text/javascript" src="../res/js/employee/window.js"></script>
...
<!-- ===================================================================================================== -->
    <?php
    //pobranie id i komórki pracownika 
    ...
    // pobranie historii wniosków pracownika
    ...
    // sprawdzenie czy użytkownik ma współpracowników
    ...
    // jeżeli brak współpracowników nie wyrzucaj błędu tylko zezwalaj na wybór pustego pola jako zastępca
    if (empty($name_collegues[0])) {
        $collegues_join = "";
    // w przeciwnym wypadku - pobierz listę pracowników (co zostanie potem wykorzystane do wyboru osoby zastępującej)
    } else {
...
<!-- ===================================================================================================== -->
    ...
    <script type="text/javascript" src="../res/js/employee/holidayrq.js"></script>
    <script type="text/javascript" src="../res/js/employee/employee.js"></script>
