    ...
    <div class="modal-content modal-add-worker">
      ...
      <form class="crud-form" action="process.php" method="POST">
        <div class="inputs">
          ...
          <input class="form-control" type="text" name="departament" id="departament" />
          ...
          <input class="form-control" type="number" name="vacation_total" id="vacation_total" min="1" max="30" value="1" />
          <label for="vacation_on">Pozostała ilość dni wolnego:</label>
          <input class="form-control" type="number" name="vacation_on" id="vacation_on" min="1" max="30" value="0" />
          <label for="id">ID:</label>
          <input class="form-control" type="number" name="id" id="id" min="1" max="30" value="0" />
        </div>
    ...
    <div class="modal-content modal-add-worker">
      ...
      <form class="crud-update" action="databaseu.php" method="POST">
        <div class="inputs">
          ...
          <label for="">Nazwisko:</label>
          <input class="form-control" type="text" name="second_name2" id="second_name2" />
          ...
          <input class="form-control" type="password2" name="password2" id="password2" />
          <label for="job_title2">Stanowisko:</label>
          <input class="form-control" type="text" name="job_title2" id="job_title2" />
          <label for="departament2">Departament:</label>
          <input class="form-control" type="text" name="departament2" id="departament2" />
          ...
          <input class="form-control" type="number" name="vacation_total2" id="vacation_total2" min="1" max="30" value="1" />
          <label for="vacation_on2">Pozostała ilość dni wolnego:</label>
          <input class="form-control" type="number" name="vacation_on2" id="vacation_on2" min="1" max="30" value="0" />
